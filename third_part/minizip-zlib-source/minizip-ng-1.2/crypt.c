...
int cryptrand(unsigned char *buf, unsigned int len)
{
    ...
    return rlen;
#else
    /*To ensure successful compilation, the line `#define NOCRYPT` was commented out, 
     which in turn resulted in an error when compiling `arc4random_buf`. 
     Therefore, to maintain the functionality of encryption compression, 
     the two lines of code below were also commented out.*/
