...
public:
    ...
    static const std::string& monitoring_enabled_var_name()
    {
        static const std::string MONITORING_ENABLED_VAR_NAME(
                "RTI_RECORDING_MONITORING");
        return MONITORING_ENABLED_VAR_NAME;
    }

    static const std::string& monitoring_domain_id_var_name()
    {
        static const std::string MONITORING_DOMAIN_ID_VAR_NAME(
                "RTI_RECORDING_MONITORING_DOMAIN_ID");
        return MONITORING_DOMAIN_ID_VAR_NAME;
    }
    ...
    static const std::string& playback_slice_period_sec_var_name()
    {
        static const std::string PLAYBACK_SLICE_PERIOD_SEC(
                "RTI_RECORDING_PLAYBACK_SLICE_PERIOD_SEC");
        return PLAYBACK_SLICE_PERIOD_SEC;
    }

    static const std::string& playback_slice_period_nanosec_var_name()
    {
        static const std::string PLAYBACK_SLICE_PERIOD_NANOSEC(
                "RTI_RECORDING_PLAYBACK_SLICE_PERIOD_NANOSEC");
        return PLAYBACK_SLICE_PERIOD_NANOSEC;
    }

    static const std::string& looping_enabled_var_name()
    {
        static const std::string LOOPING("RTI_RECORDING_LOOPING");
        return LOOPING;
    }

    static const std::string& debug_mode_enabled_var_name()
    {
        static const std::string DEBUG_MODE("RTI_RECORDING_DEBUG_MODE");
        return DEBUG_MODE;
    }
