...
/*
 * @(#)routingservice_processor.h    generated by: makeheader    Wed Mar  9 22:43:16 2022
 *
...
RTI_RoutingServiceInput_get_stream_info(RTI_RoutingServiceInput *self);
...
extern ROUTERDllExport
const struct RTI_RoutingServiceStreamInfo *
RTI_RoutingServiceOutput_get_stream_info(RTI_RoutingServiceOutput *self);
...
struct RTI_RoutingServiceProcessor{
    ...
    /*e @brief Handles event processing (\b required). */
    RTI_RoutingServiceProcessor_OnRouteEventFcn on_route_event;

    /*e @brief Handles configuration changes in a Processor (\b optional). */
    RTI_RoutingServiceProcessor_UpdateFcn update;

    /*e
     * @brief Implementation data. Provided by implementors, and passed back
     *         in API calls.
     */
    void * processor_data;
...
struct RTI_RoutingServiceProcessorPlugin {
    ...
    /*e
     * @brief The version of this ProcessorPlugin.
     */
    struct RTI_RoutingServiceVersion plugin_version;

    /*e
     * @brief Handles the deletion of the ProcessorPlugin.
     */
    RTI_RoutingServiceProcessorPlugin_DeleteFcn plugin_delete;

    /*e
     * @brief Handles the creation of Processors.
     */
    RTI_RoutingServiceProcessorPlugin_CreateProcessorFcn create_processor;

    /*e
     * @brief Handles the deletion of Processors.
     */
    RTI_RoutingServiceProcessorPlugin_DeleteProcessorFcn delete_processor;

    /*e
     * @brief A placeholder for Processor implementors to keep a pointer to data
     *        that may be needed by the implementation.
     */
    void * processor_plugin_data;
};
...
/*e \ingroup RTI_RoutingServiceProcessorModule
 *
 * @brief Utility macro to initialize a ProcessorPlugin object.
 *
 * This macro must be called to initialize the value returned by
 * RTI_RoutingServiceProcessorPlugin_CreateFcn.
 *
 * @param plugin Pointer to the ProcessorPlugin object.
 *
 * @see RTI_RoutingServiceProcessorPlugin_CreateFcn
*/
