...
/*
 * @(#)osapi_utility.h    generated by: makeheader    Wed Mar  9 22:29:45 2022
 *
...
#if defined(_WRS_KERNEL) && defined(__GNUC__)
  #define RTI_OSAPI_NO_WCHAR_HEADER
#else
  #include <wchar.h>
#endif
...
extern RTIOsapiDllExport
size_t RTIOsapiUtility_strlen(char *str);

extern RTIOsapiDllExport 
size_t RTIOsapiUtility_strnlen(const char *str, size_t maxLength);

extern RTIOsapiDllExport
size_t RTIOsapiUtility_wcslen(const wchar_t *str);

extern RTIOsapiDllExport
size_t RTIOsapiUtility_strlenFnc(char *str);
...
extern RTIOsapiDllExport
char * RTIOsapiUtility_strTrimStartEx(char *str, const char *charactersToSkip);
