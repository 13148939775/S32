...
/*
 * @(#)osapi_socket.h    generated by: makeheader    Wed Mar  9 22:29:45 2022
 *
...
typedef enum {
     ...
     * packets 
     */
    RTI_OSAPI_SOCKET_OPTION_RECV_PRIORITY     = 0x10000,
...
#define RTI_OSAPI_SOCKET_INVALID_DIFF_SERV -1


#define RTI_OSAPI_SOCKET_MAX_DIFF_SERV 0xFF

extern RTIOsapiDllExport 
int RTIOsapiSocket_recvFrom(
        int sd,
        void *buffer,
        size_t bufferSize,
