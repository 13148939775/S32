...
[table
    ...
    [[`__LIBRARY_DIR_ARM`] [__predef_detection__]]
    [[`__LIBRARY_DIR_THUMB`] [__predef_detection__]]
    [[`_M_ARM`] [__predef_detection__]]

    [[`__arm64`] [8.0.0]]
    [[`__LIBRARY_DIR_ARM`] [V.0.0]]
    [[`__LIBRARY_DIR_THUMB`] [V.0.0]]
    [[`_M_ARM`] [V.0.0]]
    ]
 */
...
#define RTIBOOST_ARCH_ARM RTIBOOST_VERSION_NUMBER_NOT_AVAILABLE
    ...
    defined(__LIBRARY_DIR_ARM) || defined(__LIBRARY_DIR_THUMB) || \
    defined(_M_ARM)
...
#   endif
#   if !defined(RTIBOOST_ARCH_ARM) && defined(__LIBRARY_DIR_ARM)
#       define RTIBOOST_ARCH_ARM RTIBOOST_VERSION_NUMBER(__LIBRARY_DIR_ARM,0,0)
#   endif
#   if !defined(RTIBOOST_ARCH_ARM) && defined(__LIBRARY_DIR_THUMB)
#       define RTIBOOST_ARCH_ARM RTIBOOST_VERSION_NUMBER(__LIBRARY_DIR_THUMB,0,0)
#   endif
