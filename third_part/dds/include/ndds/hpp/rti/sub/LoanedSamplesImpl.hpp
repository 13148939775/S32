...
public:
     ...
     */
    // Coverity suppression: Uninitialized info_seq_ is OK for performance reasons,
    // because data_seq_ is initialized and is always checked first.
...
private:
    ...
    //
    // Coverity suppressions: unintialized values here are okay,
    // since when we are swapping and the object is destroyed anyway.
