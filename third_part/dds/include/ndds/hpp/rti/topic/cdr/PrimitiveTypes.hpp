...
struct bool_serialization_impl {
    ...
    {
        DDS_Boolean tmp = *v;
        return RTICdrStream_serializeBoolean(stream, &tmp) == DDS_BOOLEAN_TRUE;
    }
...
struct wchar_serialization_impl {
    static bool serialize(RTICdrStream *stream, const wchar_t *v)
    {
        ...
        return RTICdrStream_serializeWchar(stream, &tmp) == DDS_BOOLEAN_TRUE;
    }
...
struct wchar_serialization_impl<sizeof(DDS_Wchar)> {
    static bool serialize(RTICdrStream *stream, const wchar_t *v)
    {
        return RTICdrStream_serializeWchar(
                stream,
                reinterpret_cast<const DDS_Wchar *>(v)) == DDS_BOOLEAN_TRUE;
    }
    ...
    static bool deserialize(RTICdrStream *stream, wchar_t *v)
    {
        return RTICdrStream_deserializeWchar(
                stream,
                reinterpret_cast<DDS_Wchar*>(v)) == DDS_BOOLEAN_TRUE;
    }
