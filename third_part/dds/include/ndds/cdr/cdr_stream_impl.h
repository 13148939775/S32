...
/*
 * @(#)cdr_stream_impl.h    generated by: makeheader    Wed Mar  9 22:30:05 2022
 *
...
#define RTICdrStream_setEncapsulationOptions(me__, options__) ( \
(me__)->_encapsulationOptions = (options__))
