...
/*
 * @(#)pres_participant.h    generated by: makeheader    Wed Mar  9 22:30:19 2022
 *
...
struct PRESParticipantSecurityAttributes {
    ...
    /*
     * Determines if the security plugins support endpoint preunregistering.
     * This feature allows the participant to increase the concurrency of the
     * submessage decoding: when supported, we don't need to take the match
     * table EA (participant EA) to call preprocess and decode submessage APIs.
     *
     * This is possible because we use preunregister+unregister in
     * combination with REDA tables recordRemoval+recordFinalization to
     * provide high concurrent (and thread safe) endpoint handle access.
     */
    RTIBool isPreUnregisteringEndpointsSupported;
...
{ \
    ...
    RTI_FALSE, /* isPreUnregisteringEndpointsSupported */ \
...
struct PRESParticipantSecurityForwarder {
    ...
    PRESParticipant_ReturnObjectFunction preUnregisterDataReader;
    PRESParticipant_ReturnObjectFunction preUnregisterDataWriter;
...
extern PRESDllExport struct PRESLocalEndpoint *
PRESParticipant_createLocalEndpoint(
        struct PRESParticipant *me,
        int *failReason,
        RTIBool *autoenableContainedEntities,
        struct PRESGroup *group,
        ...
        PRESStatusKindMask internalListenerMask,
        PRESStatusKindMask userListenerMask,
        struct REDAWorker *worker);
