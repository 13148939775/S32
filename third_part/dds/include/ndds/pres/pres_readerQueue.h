...
/*
 * @(#)pres_readerQueue.h    generated by: makeheader    Wed Mar  9 22:30:19 2022
 *
...
struct PRESReaderQueueProperty {
    /*
     * Pool buffer threshold for sample serialization.
     * UNLIMITED by default or set by user via the property
     * NDDS_DRHISTORY_MEMORYMANAGER_FASTPOOL_POOLBUFFERMAXSIZE
     */
    int cdrPoolBufferThreshold;

    /*
     * Maximum value for a serialized sample received on an unprotected channel.
     */
    RTI_UINT32 unprotectedChannelsMaxLength;

    /*
     * Configuration for the threshold buffer pools.
     */
    REDAThresholdBufferPoolProperty poolProperty;
...
#define PRES_READER_QUEUE_PROPERTY_DEFAULT { \
    PRES_LENGTH_UNLIMITED, /* cdrPoolBufferThreshold */ \
    MIG_UNPROTECTED_CHANNELS_MAX_LENGTH_DEFAULT, /* unprotectedChannelsMaxLength */ \
    REDA_THRESHOLD_BUFFER_POOL_PROPERTY_DEFAULT, /* poolProperty */ \
