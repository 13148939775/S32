...
/*
 * @(#)pres_psReaderWriter_impl.h    generated by: makeheader    Wed Mar  9 22:30:19 2022
 *
...
#define PRESPsWriter_setListener(               \
        me__,                                   \
        failReason__,                           \
        listener__,                             \
        mask__,                                 \
        worker__)                               \
    (me__)->_service->setLocalEndpointListener( \
            (me__)->_service,                   \
            (failReason__),                     \
            (me__),                             \
            (listener__),                       \
...
#define PRESPsReader_setListener(               \
        me__,                                   \
        failReason__,                           \
        listener__,                             \
        internalMask__,                         \
