...
/*
 * @(#)dds_c_builtin.h    generated by: makeheader    Wed Mar  9 22:30:23 2022
 *
...
DDS_SEQUENCE(
        DDS_VirtualSubscriptionBuiltinTopicDataSeq,
        struct DDS_VirtualSubscriptionBuiltinTopicData);


DDS_TYPESUPPORT_C(
        DDS_VirtualSubscriptionBuiltinTopicDataTypeSupport,
        struct DDS_VirtualSubscriptionBuiltinTopicData);


DDS_DATAREADER_C(
        DDS_VirtualSubscriptionBuiltinTopicDataDataReader,
        DDS_VirtualSubscriptionBuiltinTopicDataSeq,
        struct DDS_VirtualSubscriptionBuiltinTopicData);


DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_C(
        DDS_VirtualSubscriptionBuiltinTopicDataDataWriter,
        struct DDS_VirtualSubscriptionBuiltinTopicData);
...
DDS_TYPESUPPORT_C(
        DDS_ParticipantGenericMessageTypeSupport,
        DDS_ParticipantGenericMessage);


DDS_DATAREADER_C(
        DDS_ParticipantGenericMessageDataReader,
        DDS_ParticipantGenericMessageSeq,
        DDS_ParticipantGenericMessage);


DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_C(
        DDS_ParticipantGenericMessageDataWriter,
        DDS_ParticipantGenericMessage);
