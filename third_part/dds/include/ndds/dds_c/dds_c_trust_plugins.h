...
/*
 * @(#)dds_c_trust_plugins.h    generated by: makeheader    Wed Mar  9 22:30:25 2022
 *
...
typedef struct DDS_InterceptorPlugin {
    ...
    DDS_Interceptor_UnregisterFunction preunregister_datawriter;
    DDS_Interceptor_UnregisterFunction preunregister_datareader;
...
#define DDS_Interceptor_INITIALIZER { \
        NULL, /* plugin_data */ \
        NULL, /* logging */ \
        NULL, /* register_local_participant */ \
        NULL, /* register_matched_remote_participant */ \
        NULL, /* register_local_datawriter */ \
        NULL, /* register_matched_remote_datareader */ \
        NULL, /* register_local_datareader */ \
        NULL, /* register_matched_remote_datawriter */ \
        NULL, /* preunregister_datawriter */ \
        NULL, /* preunregister_datareader */ \
        NULL, /* unregister_participant */ \
        NULL, /* unregister_datawriter */ \
        NULL, /* unregister_datareader */ \
        NULL, /* create_local_participant_interceptor_state */ \
        NULL, /* set_remote_participant_interceptor_state */ \
        NULL, /* create_local_datawriter_interceptor_state */ \
        NULL, /* set_remote_datawriter_interceptor_state */ \
        NULL, /* create_local_datareader_interceptor_state */ \
        NULL, /* set_remote_datareader_interceptor_state */ \
        NULL, /* set_local_datawriter_interceptor_state */ \
        NULL, /* return_interceptor_state */ \
        NULL, /* transform_outgoing_local_datawriter_interceptor_state */ \
        NULL, /* transform_incoming_local_datawriter_interceptor_state */ \
        NULL, /* transform_outgoing_serialized_data */ \
        NULL, /* transform_outgoing_datawriter_submessage */ \
        NULL, /* transform_outgoing_datareader_submessage */ \
        NULL, /* transform_outgoing_rtps_message */ \
        NULL, /* transform_outgoing_rtps_message_with_preshared_secret */ \
        NULL, /* preprocess_interceptor_submsg */ \
        NULL, /* transform_incoming_rtps_message_with_preshared_secret */ \
        NULL, /* transform_incoming_rtps_message */ \
        NULL, /* transform_incoming_datawriter_submessage */ \
        NULL, /* transform_incoming_datareader_submessage */ \
        NULL, /* transform_incoming_serialized_data */ \
        NULL, /* get_transformed_outgoing_serialized_sample_size */ \
        NULL, /* get_transformed_datawriter_submessage_max_serialized_size */ \
        NULL, /* get_transformed_datareader_submessage_max_serialized_size */ \
        NULL, /* get_transformed_rtps_message_max_serialized_size */ \
        NULL  /* get_transformed_rtps_message_with_preshared_secret_max_serialized_size */ \
}
