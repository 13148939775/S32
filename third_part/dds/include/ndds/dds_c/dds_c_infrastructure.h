...
/*
 * @(#)dds_c_infrastructure.h    generated by: makeheader    Wed Mar  9 22:30:24 2022
 *
...
typedef struct DDS_LocatorReachabilityLocator_t {
    /*i \dref_LocatorReachabilityLocator_t_kind
     */
    DDS_Long kind;
    /*i \dref_LocatorReachabilityLocator_t_port
     */
    DDS_UnsignedLong port;
    /*i \dref_LocatorReachabilityLocator_t_address
     */
    DDS_Octet address[DDS_LOCATOR_ADDRESS_LENGTH_MAX];

} DDS_LocatorReachabilityLocator_t;


DDS_SEQUENCE(DDS_LocatorReachabilityLocator_tSeq, DDS_LocatorReachabilityLocator_t);
...
typedef enum {
    /*e \dref_DiscoveryConfigBuiltinPluginKind_DISCOVERYCONFIG_BUILTIN_SPDP
     */
    DDS_DISCOVERYCONFIG_BUILTIN_SPDP = 0x0001 << 0,
    /*e \dref_DiscoveryConfigBuiltinPluginKind_DISCOVERYCONFIG_BUILTIN_SEDP
     */
...
/*i \dref_DISCOVERYCONFIG_BUILTIN_PLUGIN_MASK_ALL
 */
...
struct DDS_DataHolderSeqHelper;

struct DDS_DataHolderSeqHelper {
    struct DDS_DataHolderSeq *DataHolderSequence;
};
